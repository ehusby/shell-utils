...
The first time you run a starter command such as `osgeo`, `osgeo2`, or `osgeo3`, a real Windows shortcut is automatically generated in the [`shell-utils/windows/shortcuts`](./shortcuts) folder in this repo. Once you've run `osgeo3` and it generated a shortcut at `shell-utils/windows/shortcuts/start_osgeo_py3.lnk`, I recommend you copy this shortcut into the folder containing OSGeo4W's Start Menu shortcuts at `C:\ProgramData\Microsoft\Windows\Start Menu\Programs\OSGeo4W`, and rename this shortcut "OSGeo4W Shell - Python3".
