...
if not exist %target_path% (
    ...
    call %target_path% & cmd /k "@ECHO OFF&set PATH=%%PATH%%;%PATH%;&py3_env&@ECHO ON&echo 'py3_env' has been loaded.&python %1"
) else (
    title OSGeo4W Shell - Python3
    call %target_path% & cmd /k "@ECHO OFF&set PATH=%%PATH%%;%PATH%;&@ECHO ON&python %1"
)
