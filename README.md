...
1. Generate an SSH key on your local machine by running `ssh-keygen -t ed25519`. I'd recommend setting a short and memorable passphrase that is similar to a bank PIN in complexity, but a bit stronger (please don't actually use your bank PIN).
2. Run `cat ~/.ssh/id_ed25519.pub` to print your *public* SSH key in the terminal. This is the key we need to give to GitHub.
